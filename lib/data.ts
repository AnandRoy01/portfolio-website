...
export const fullProjectDetails = [
  ...
  {
    year: "2023",
    project: "Browserstack Chrome Extension",
    projectLink:
      "https://chromewebstore.google.com/detail/browserstack/nkihdmlheodkdfojglpcjjmioefjahjb",
    madeAt: "Browserstack",
    tech: ["React", "javascript", "chrome extension", "gulp"],
    linkText: "Browserstack Chrome Extension",
  },
  {
    year: "2023",
  ...
  {
    year: "2022",
    project: "Browserstack WebRtc Troubleshooter",
    projectLink: "https://live.browserstack.com/network_assessment_tool",
    madeAt: "Browserstack",
    tech: ["React", "javascript", "webRtc", "scss"],
    linkText: "Browserstack WebRtc Troubleshooter",
  },
  {
    year: "2022",
